...
| [給 AI 超能力？Superpowers 的設計與取捨](https://kaochenlong.com/ai-superpowers-skills) | 結尾延伸，2–3 張 |
...
僅在三處使用 `v-click`：三階段流程圖逐階段出現、Vibe Coding 三個問題逐條出現、Delta 三種標記逐個出現。其餘靜態。
